...
export const fetchApi = createAsyncThunk("fetchApi",async()=>{
    return await axios.get("http://localhost:3000/student")
    .then((data)=>{
        return data.data
    })
})
...
export const postApi =createAsyncThunk("postApi",async(obj)=>{
    return await axios.post("http://localhost:3000/student",obj)
    .then((data)=>{
        return data.data
    })
})
...
export const updateApi = createAsyncThunk("updateApi",async(obj)=>{
    const data= await axios.put('http://localhost:3000/student/${obj.id},obj')
        return data.data
})
