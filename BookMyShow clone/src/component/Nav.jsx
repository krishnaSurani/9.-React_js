  ...
  return (
    <div className='h-[60px] w-full'>
        <div className='h-[80%] w-[80%] m-auto mt-2 flex'>
            ...
            <div className="h-full w-[38%]"><input type="text" placeholder='🔍 Search for Movies, Events, plays, Spots and Activities'  className='border border-[#EEEEEE] w-full ps-2 h-[85%] mt-1 shadow-sm' onChange={(e)=>setstate(e.target.value)}/></div>
